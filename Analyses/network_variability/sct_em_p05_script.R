...
#### Scot Eigen Random ####
network <-
  readRDS("~/different_sources_influence/Analyses/network_variability/scot_eigen_max.rds")
...
saveRDS(d5, "~/different_sources_influence/Analyses/network_variability/sct_em_p05.rds")