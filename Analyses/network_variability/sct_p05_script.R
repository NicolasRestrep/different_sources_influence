...
#### Paul Revere Net ####
network <-
  readRDS("~/different_sources_influence/Analyses/network_variability/scotland_board_members.rds")
...
saveRDS(d5, "~/different_sources_influence/Analyses/network_variability/sct_p05.rds")