...
#### Paul Revere Net ####
network <-
  readRDS("~/different_sources_influence/Analyses/network_variability/pr_eigen_max.rds")
...
saveRDS(d5, "~/different_sources_influence/Analyses/network_variability/pr_em_p05.rds")