...
#### Paul Revere Net ####
network <-
  readRDS("~/different_sources_influence/Analyses/network_variability/paul_revere_network.rds")
...
saveRDS(d5, "~/different_sources_influence/Analyses/network_variability/pr_p05.rds")